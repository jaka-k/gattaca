...
class JdbcCityService(private val connection: Connection) : ICityService {
    companion object {
    ...
    // Create new city
    override suspend fun create(city: City): Int = withContext(Dispatchers.IO) {
    ...
    // Read a city
    override suspend fun read(id: Int): City = withContext(Dispatchers.IO) {
